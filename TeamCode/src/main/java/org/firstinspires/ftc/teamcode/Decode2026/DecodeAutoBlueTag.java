...
@Autonomous(name = "Decode Auto Blue Tag")
public class DecodeAutoBlueTag extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(Running)
        {
            ...
            Functions.turn2(this, hardwareMap, telemetry, 500, "Right", 0.5, testMode);

            Functions.drive(this, hardwareMap, telemetry, 14, 14, -0.55, 14, 14, testMode);

            Functions.turn2(this, hardwareMap, telemetry, 1000, "Left", 0.5, testMode);
            ...
            Functions.turn2(this, hardwareMap, telemetry, 650, "Right", 0.5, testMode);

            // Turn on flywheel
            telemetry.addData("Current Action", "Turn on flywheel");
            telemetry.update();
            LauncherMotor.setPower(flywheel_Speed);
            ...
            Functions.turn(this, hardwareMap, telemetry, "Slight-Left", 0.5, testMode);
